# Modified for IS hand detection
...
class pascal_voc(imdb):
  def __init__(self, image_set, year, devkit_path=None):
    ...
    self._data_path = os.path.join(self._hand_path, 'ISIS','detectiondata') #Same as VOC2007/
  ...
  def _load_pascal_annotation(self, index):
    ...
    for ix, obj in enumerate(objs):
      ...
      # [Hand Detection] Different from LISA, keep -1
